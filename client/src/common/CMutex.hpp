...
{
public:
    void lock_shared() { static_cast<derived_t*>(this)->m_pMutex->lock_shared(); }
    void unlock_shared() { static_cast<derived_t*>(this)->m_pMutex->unlock_shared(); }
    [[nodiscard]] bool try_lock_shared() { return static_cast<derived_t*>(this)->m_pMutex->try_lock_shared(); }
};
...
public:
    ...
    [[nodiscard]] bool try_lock() { return m_pMutex->try_lock(); }
private:
